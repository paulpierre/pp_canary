...
namespace Traits {
    ...
    trait ArrayUniqueTrackingDb {
        
        private function setArrayUniqueTrackingDb(){
            ...
            if(isset($this -> data[$this -> action])){
                ...
                foreach($this -> data[$this -> action] as $_v){
                    ...
                    if(sizeof($_result) > 0){
                        foreach ($_result as $v) {
                            ...
                            if( $_v['order_receipt_id']         == $v['order_receipt_id'] && 
                                ...
                                $_v['fulfillment_id']           == $v['fulfillment_id']
                                    ){
                                $duplicate = 1;
                            }                        
                        }
                ...
                $this -> array_unique_tracking_db = $_result;
            }
