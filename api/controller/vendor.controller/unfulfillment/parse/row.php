...
namespace Unfulfillment\Parse {
    ...
    class Row extends ExcelRow {
         ...
         *     |                                                |                           |
         *     |                                                |                           |
         *     NO |-> getResultsFromTrackingNumberCell() <-| NO                             |     
         *             |            |                                                       |
         *             |            |                                                       |
         ...
         *             |                                        |                       |                   |                   |       |              
         *             |                                        |                       |                   |                   |       |              
         *             |                                        |                       |                   |                   |       YES --> |-> ROW_ACTION_UNFULFILLMENT | ROW_STATUS_SUCCESS | ERROR_ROW_PARSING_NO_ERROR                   
         *             |                                        |                       |                   |                   |                   ------------------------
         *             |                                        |                       |                   |                   |
         ...
         *             |                                        |                       |
         *             |                                        |                       |
         *             |                                        |                       NO -> ROW_ACTION_NONE | ROW_STATUS_FAILURE | ERROR_ROW_PARSING_TRACKING_NUMBER_NOT_FOUND
         *             |                                        |  
         *             |                                        |
         *             |                                        NO -> ROW_ACTION_NONE | ROW_STATUS_FAILURE | ERROR_ROW_PARSING_FULFILLMENT_ID_NOT_FOUND
         *             |        
         *             |        
        ...
        private function getResultsIsTrackingSet(){
            ...
            if(!empty($this -> tracking_number) && $this -> flag_is_empty_fulfilment_tracking_number == 0){
                ...
                if(!empty($this -> order_shopify_id)){
                    ...
                    $data = $this -> getResultsFromOrders();
        ...
        private function getResultItems(){
            ...
            if(!empty($data)){
                ...
                $this -> row_action = ROW_ACTION_UNFULFILLMENT;
        ...
        private function setTrackingNumberCell(){
            ...
            if(!isset($this -> row[$this -> tracking_number_column_index])){
