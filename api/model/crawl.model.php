...
class Crawl extends Database {
    ...
    public $previous_delivery_status            = null;
    public $tstart                              = null;
    public $tfinish                             = null;


    //NON-DATABASE
    public $proxy_ip_address                    = null;
    public $proxy_port                          = null;
    public $proxy_delay                         = null;

    //RESULTS FROM THE CRAWL
    public $last_date                           = null;
    public $last_location                       = null;
    public $last_location2                      = null;
    public $last_status_text                    = null;
    public $last_status                         = null;

    public $FK_PREFIX_ARRAY      = Array('order_','fulfillment_','proxy_','last_');
