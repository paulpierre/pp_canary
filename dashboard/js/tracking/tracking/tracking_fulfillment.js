 ...
 *  THIS SITE NAME
 *  -------------- */
var thisSite = 'tracking_fulfillment';
...
function sendConfirmation(){
    ...
    var ajax_url = API_URL + 'vendor/tracking_confirm/' + result_vendor_id;
...
$("[data-vendor]").click(function(event){
    ...
    Dropzone.options.mDropzoneXls.params.url = API_URL + 'vendor/tracking_parse/' + vendor_id;
